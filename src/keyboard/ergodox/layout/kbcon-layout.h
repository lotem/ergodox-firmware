...
ERGODOX_LAYOUT = {
  ERGODOX_LAYER( // L0: Typewriter
    ...
    _(_equal),      _(_N),          _(_M),          _(_comma),      _(_period),     _(_slash),      S2CAP(_shiftR),
                                    CHORD(1),       CHORD(9),       _(_guiR),       _(_altR),       _(_ctrlR),
    _(_ctrlR),      _(_bs),
    _(_altR),
  ...
  ERGODOX_LAYER( // L9: layout switcher
    ...
    UNUSED,         UNUSED,         UNUSED,         _(_end),        UNUSED,         UNUSED,         UNUSED,
    UNUSED,         _(_home),       UNUSED,         _(_del),        _(_arrowR),     _(_esc),
    UNUSED,         UNUSED,         UNUSED,         UNUSED,         _(_pageD),      _(_arrowL),     UNUSED,
    ...
    UNUSED,         UNUSED,         _(_pageU),      _(_tab),        UNUSED,         _(_arrowU),     UNUSED,
    /*_*/           _(_bs),         _(_enter),      UNUSED,         UNUSED,         UNUSED,         UNUSED,
    UNUSED,         _(_arrowD),     _(_enter),      UNUSED,         UNUSED,         UNUSED,         UNUSED,
                                    UNUSED,         UNUSED,         UNUSED,         UNUSED,         UNUSED,
    UNUSED,         UNUSED,
    UNUSED,
    UNUSED,         UNUSED,         UNUSED
