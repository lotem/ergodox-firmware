...
ERGODOX_LAYOUT = {
  ...
  ERGODOX_LAYER( // L8: Ngaih
    // left hand
    __,             _(_T),          _(_J),          _(_Q),          _(_K),          _(_dash),       _(_equal),
    _(_D),          _(_O),          _(_E),          _(_U),          _(_F),          _(_P),          _(_M),
    _(_L),          _(_N),          _(_G),          _(_A),          _(_I),          _(_W),
    __,             _(_Z),          _(_S),          _(_C),          _(_X),          _(_R),          _(_V),
    _(_slash),      _(_comma),      _(_period),     _(_semicolon),  _(_Y),
                                                                                    _(_bs),          _(_tab),
                                                                                                    _(_enter),
                                                                    _(_H),          _(_B),          _(_space),
    // right hand
